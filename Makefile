.PHONY: venv venv-recreate install extract-pdf llm-smoke ingest-paper okf-lint build-wiki build-wiki-docker deploy-wiki-gcp serve-wiki serve-wiki-docker prepare-content
